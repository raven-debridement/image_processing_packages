"""autogenerated by genpy from stereo_click/ClickPoint.msg. Do not edit."""
import sys
...
class ClickPoint(genpy.Message):
  _md5sum = "01b0bad5d5acf62ac7e55053fabe6ea9"
  _type = "stereo_click/ClickPoint"
...
"""
  __slots__ = ['x','y','camera_info']
  _slot_types = ['float32','float32','sensor_msgs/CameraInfo']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ClickPoint, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2f3I.pack(_x.x, _x.y, _x.camera_info.header.seq, _x.camera_info.header.stamp.secs, _x.camera_info.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.x, _x.y, _x.camera_info.header.seq, _x.camera_info.header.stamp.secs, _x.camera_info.header.stamp.nsecs,) = _struct_2f3I.unpack(str[start:end])
      start = end
      end += 4
