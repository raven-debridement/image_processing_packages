...
;//! \htmlinclude ConvertPoint-request.msg.html

(cl:defclass <ConvertPoint-request> (roslisp-msg-protocol:ros-message)
  ((click_point
    :reader click_point
    :initarg :click_point
...
(cl:defclass ConvertPoint-response (<ConvertPoint-response>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ConvertPoint-response>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ConvertPoint-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stereo_click-srv:<ConvertPoint-response> is deprecated: use stereo_click-srv:ConvertPoint-response instead.")))

(cl:ensure-generic-function 'pt3d-val :lambda-list '(m))
(cl:defmethod pt3d-val ((m <ConvertPoint-response>))
  ...
  (pt3d m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ConvertPoint-response>) ostream)
  "Serializes a message object of type '<ConvertPoint-response>"
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'pt3d) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ConvertPoint-response>) istream)
  "Deserializes a message object of type '<ConvertPoint-response>"
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'pt3d) istream)
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConvertPoint-response>)))
  "Returns string type for a service object of type '<ConvertPoint-response>"
  "stereo_click/ConvertPointResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConvertPoint-response)))
  "Returns string type for a service object of type 'ConvertPoint-response"
  "stereo_click/ConvertPointResponse")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ConvertPoint-response>)))
  "Returns md5sum for a message object of type '<ConvertPoint-response>"
  "2ccb15871e57392cb262c1d7ec97e26a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ConvertPoint-response)))
  "Returns md5sum for a message object of type 'ConvertPoint-response"
  "2ccb15871e57392cb262c1d7ec97e26a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ConvertPoint-response>)))
  "Returns full string definition for message of type '<ConvertPoint-response>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ConvertPoint-response)))
  "Returns full string definition for message of type 'ConvertPoint-response"
  (cl:format cl:nil "geometry_msgs/PointStamped pt3d~%~%~%================================================================================~%MSG: geometry_msgs/PointStamped~%# This represents a Point with reference coordinate frame and timestamp~%Header header~%Point point~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ConvertPoint-response>))
  (cl:+ 0
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'pt3d))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ConvertPoint-response>))
  "Converts a ROS message object to a list"
  (cl:list 'ConvertPoint-response
    (cl:cons ':pt3d (pt3d msg))
))
(cl:defmethod roslisp-msg-protocol:service-request-type ((msg (cl:eql 'ConvertPoint)))
  'ConvertPoint-request)
(cl:defmethod roslisp-msg-protocol:service-response-type ((msg (cl:eql 'ConvertPoint)))
  'ConvertPoint-response)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConvertPoint)))
  "Returns string type for a service object of type '<ConvertPoint>"
  "stereo_click/ConvertPoint")